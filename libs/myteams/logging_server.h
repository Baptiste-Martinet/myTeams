...
\param user_name a character pointer corresponding to the
...
/*!
\param sender_id a character pointer corresponding
to the universally unique identifier corresponding to the
